...
DEPLOYMENT_JSON=$(cat $MXC_MONO_DIR/packages/protocol/deployments/deploy_l1.json)
MXC_L1_CONTRACT_ADDRESS=$(echo $DEPLOYMENT_JSON | jq '.mxc' | sed 's/\"//g')
...
echo "MXC_L1_CONTRACT_ADDRESS: $MXC_L1_CONTRACT_ADDRESS"
