...
// ProposeBlock is a paid mutator transaction binding the contract method 0xd412f8b7.
//
// Solidity: function proposeBlock(bytes input, bytes txList, bytes signature, uint128 txListLength, uint128 estimateGas) returns((uint64,uint64,uint64,bytes32,bytes32,bytes32,uint24,uint24,uint32,address,address,(address,uint96,uint64)[],uint256,uint256) meta)
func (_MxcL1Client *MxcL1ClientTransactor) ProposeBlock(opts *bind.TransactOpts, input []byte, txList []byte, signature []byte, txListLength *big.Int, estimateGas *big.Int) (*types.Transaction, error) {
	return _MxcL1Client.contract.Transact(opts, "proposeBlock", input, txList, signature, txListLength, estimateGas)
}

// ProposeBlock is a paid mutator transaction binding the contract method 0xd412f8b7.
//
// Solidity: function proposeBlock(bytes input, bytes txList, bytes signature, uint128 txListLength, uint128 estimateGas) returns((uint64,uint64,uint64,bytes32,bytes32,bytes32,uint24,uint24,uint32,address,address,(address,uint96,uint64)[],uint256,uint256) meta)
func (_MxcL1Client *MxcL1ClientSession) ProposeBlock(input []byte, txList []byte, signature []byte, txListLength *big.Int, estimateGas *big.Int) (*types.Transaction, error) {
	return _MxcL1Client.Contract.ProposeBlock(&_MxcL1Client.TransactOpts, input, txList, signature, txListLength, estimateGas)
}

// ProposeBlock is a paid mutator transaction binding the contract method 0xd412f8b7.
//
// Solidity: function proposeBlock(bytes input, bytes txList, bytes signature, uint128 txListLength, uint128 estimateGas) returns((uint64,uint64,uint64,bytes32,bytes32,bytes32,uint24,uint24,uint32,address,address,(address,uint96,uint64)[],uint256,uint256) meta)
func (_MxcL1Client *MxcL1ClientTransactorSession) ProposeBlock(input []byte, txList []byte, signature []byte, txListLength *big.Int, estimateGas *big.Int) (*types.Transaction, error) {
	return _MxcL1Client.Contract.ProposeBlock(&_MxcL1Client.TransactOpts, input, txList, signature, txListLength, estimateGas)
}
