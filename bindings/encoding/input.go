...
var MxcL1OldClientMetaData = &bind.MetaData{
...
func init() {
	...
	if MxcOldL1ABI, err = MxcL1OldClientMetaData.GetAbi(); err != nil {
		log.Crit("Get MxcL1Old ABI error", "error", err)
	}
...
func UnpackTxListBytes(txData []byte) ([]byte, error) {
	...
	if err != nil {
		method, err = MxcOldL1ABI.MethodById(txData)
		if err != nil {
			return nil, err
		}
		return nil, err
